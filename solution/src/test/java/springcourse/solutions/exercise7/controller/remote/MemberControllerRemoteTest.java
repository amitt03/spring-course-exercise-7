package springcourse.solutions.exercise7.controller.remote;
...
public class MemberControllerRemoteTest {
    ...
    private Book loanBook(String memberId, String catalogId) {
        Book response = restTemplate.postForObject(baseUrl + "/members/{memberId}/loanedBooks", catalogId, Book.class, memberId);
        return response;
    }
